...
// ── MOBILITY VIEW — routines library + consistency log ────────
// The mobility/yoga pillar: an expandable routines library (prime, foam
// roll, yoga) and the logged-session streak. `mobOpen`/`setMobOpen` are the
// lifted expand-state for which routine card is open.
export default function MobilityView({ mobOpen, setMobOpen }) {
  return (
    <>
      <div
        style={{
